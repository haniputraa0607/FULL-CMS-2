            ...
            <li class="nav-item {{($menu_active == 'employee') ? 'active open' : ''}}">
                ...
                <ul class="sub-menu">
                    <li class="nav-item {{($submenu_active == 'employee-office-hours') ? 'active open' : ''}}">
                        ...
                        <ul class="sub-menu">
                            ...
                            @if(MyHelper::hasAccess([442,443,445,446], $grantedFeature))
								...
								<li class="nav-item {{(isset($child_active) && $child_active == 'employee-assigned-office-hours-list') ? 'active open' : ''}}">
									<a href="{{url('employee/office-hours/assign')}}" class="nav-link ">
										<span class="title">Assigned Office Hours List</span>
									</a>
								</li>
                            @endif
                        </ul>
					...
					<li class="nav-item {{($submenu_active == 'employee-announcement') ? 'active open' : ''}}">
						...
						<ul class="sub-menu">
							<li class="nav-item {{ (isset($child_active) && $child_active == 'employee-announcement-create') ? 'active open' : '' }}">
								<a href="{{ url('employee/announcement/create') }}" class="nav-link ">
									<span class="title">New Announcement</span>
								</a>
							</li>
							<li class="nav-item {{ (isset($child_active) && $child_active == 'employee-announcement-list') ? 'active open' : '' }}">
								<a href="{{ url('employee/announcement') }}" class="nav-link ">
...
{{-- 					@if(MyHelper::hasAccess([48], $grantedFeature))
		...
		<li class="nav-item {{($menu_active == 'locations') ? 'active open' : ''}}">
			<a href="javascript:;" class="nav-link nav-toggle">
				...
				<span class="title">Partner Locations</span>
		...
		<li class="nav-item {{($menu_active == 'hair-stylist') ? 'active open' : ''}}">
			...
			<ul class="sub-menu">
				...
				<li class="nav-item {{($submenu_active == 'hair-stylist-announcement') ? 'active open' : ''}}">
					<a href="javascript:;" class="nav-link nav-toggle">
						<span class="title">Announcement</span>
						<span class="arrow"></span>
					</a>
					<ul class="sub-menu">
						<li class="nav-item {{ (isset($child_active) && $child_active == 'hair-stylist-announcement-create') ? 'active open' : '' }}">
							<a href="{{ url('recruitment/hair-stylist/announcement/create') }}" class="nav-link ">
								<span class="title">New Announcement</span>
							</a>
						</li>
						<li class="nav-item {{ (isset($child_active) && $child_active == 'hair-stylist-announcement-list') ? 'active open' : '' }}">
...
{{--                 <li class="nav-item {{ (isset($child_active) && $child_active == 'hairstylist-attendance-request') ? 'active open' : '' }}">
        ...
        <li class="nav-item {{($menu_active == 'hair-stylist-group') ? 'active open' : ''}}">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item {{($submenu_active == 'new-hair-stylist-group') ? 'active open' : ''}}">
                    <a href="{{url('recruitment/hair-stylist/group/create')}}" class="nav-link ">
                        <span class="title">New Hair Stylist Group</span>
                    </a>
                </li>
                @endif
                @if(MyHelper::hasAccess([393], $grantedFeature) || MyHelper::hasAccess([378], $grantedFeature) )
                <li class="nav-item {{($submenu_active == 'list-hair-stylist-group') ? 'active open' : ''}}">
                        <a href="{{url('recruitment/hair-stylist/group/')}}" class="nav-link ">
                                <span class="title">List Hair Stylist Group</span>
                        </a>
                </li>
                @endif
            </ul>
        ...
        <li class="nav-item {{($menu_active == 'request-product') ? 'active open' : ''}}">
            <a href="javascript:;" class="nav-link nav-toggle">
                <i class="fa fa-dropbox"></i>
                <span class="title">Request Product</span>
                <span class="arrow {{($menu_active == 'request-product') ? 'open' : ''}}"></span>
            </a>
            <ul class="sub-menu">
                @if(MyHelper::hasAccess([410], $grantedFeature))
                <li class="nav-item {{($submenu_active == 'create-request-product') ? 'active open' : ''}}">
                    <a href="{{url('req-product/create')}}" class="nav-link ">
                        <span class="title">Create Request Product</span>
                    </a>
                </li>
                @endif
                @if(MyHelper::hasAccess([411], $grantedFeature))
                <li class="nav-item {{($submenu_active == 'list-request-product') ? 'active open' : ''}}">
                    <a href="{{url('req-product')}}" class="nav-link ">
                        <span class="title">List Request Product</span>
                    </a>
                </li>
                @endif
