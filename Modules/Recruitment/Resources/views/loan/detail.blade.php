        ...
        <div class="tabbable-line tabbable-full-width">
            ...
            <div class="tab-pane active" id="update">
                <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="{{url('recruitment/hair-stylist/loan/sales/create')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 input-group">
                                        <input class="form-control" name="id_user_hair_stylist" id="id_user_hair_stylist" value="{{$data['fullname']}}" data-placeholder="Select Employee" disabled="">
                                        <input class="form-control" type="hidden" name="id_user_hair_stylist" id="id_user_hair_stylist" value="{{$data['id_user_hair_stylist']}}" data-placeholder="Select Employee" >
                                        <input class="form-control" type="hidden" name="id_hairstylist_sales_payment" id="id_hairstylist_sales_payment" value="{{$data['id_hairstylist_sales_payment']}}" data-placeholder="Select Employee" >
