@include('recruitment::default_income.potongan.filter')
<?php
    ...
    <div class="portlet light bordered">
        ...
        <div class="tab-content">
                                        ...
                                        @foreach($data as $dt)
                                            <tr data-id="{{ $dt['id_hairstylist_group_default_potongans'] }}">
                                                ...
                                                <td style="text-align: center;">
                                                   <a href="{{ url('recruitment/hair-stylist/default/potongan/detail/'.$dt['id_enkripsi']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-search"></i> Detail</a>
                                                   <a class="btn btn-sm red btn-primary" href="{{url('recruitment/hair-stylist/default/potongan/delete/'.$dt['id_enkripsi'])}}"><i class="fa fa-trash-o"></i> Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
            ...
            <div class="tab-pane" id="create">
                <form class="form-horizontal" role="form" action="{{url('recruitment/hair-stylist/default/potongan/create')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
