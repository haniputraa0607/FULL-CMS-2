...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject sbold uppercase font-blue">Default Overtime Day Salary Hair Stylist</span>
            </div>
        </div>
        <div class="tabbable-line tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#overview" data-toggle="tab"> List Default Overtime Day</a>
                </li>
                <li>
                    <a href="#create" data-toggle="tab">Create Default Overtime Day</a>
                </li>
            </ul>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="kt_datatable">
                                    ...
                                    @if(!empty($data))
                                        @foreach($data as $dt)
                                            <tr data-id="{{ $dt['id_hairstylist_group_default_overtime_day'] }}">
                                                <td style="text-align: center;">{{$dt['days']}}</td>
                                                <td style="text-align: center;">{{"Rp " . number_format($dt['value']??0,2,',','.')}}</td>
                                                <td style="text-align: center;">
                                                   <a href="{{ url('recruitment/hair-stylist/default/overtime-day/detail/'.$dt['id_enkripsi']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-search"></i> Detail</a>
                                                   <a class="btn btn-sm red btn-primary" href="{{url('recruitment/hair-stylist/default/overtime-day/delete/'.$dt['id_enkripsi'])}}"><i class="fa fa-trash-o"></i> Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
            ...
            <div class="tab-pane" id="create">
                <form class="form-horizontal" role="form" action="{{url('recruitment/hair-stylist/default/overtime-day/create')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
