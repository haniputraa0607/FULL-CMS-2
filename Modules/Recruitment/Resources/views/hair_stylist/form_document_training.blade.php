	...
	<form class="form-horizontal" id="form_training" role="form" action="{{url($url_back.'/update/'.$detail['id_user_hair_stylist'])}}" method="post" enctype="multipart/form-data">
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input class="form-control" maxlength="200" type="text" name="data_document[process_name_by]"  @if(isset($dataDoc['Training Completed']['process_name_by'])) value="{{$dataDoc['Training Completed']['process_name_by']}}" disabled @endif placeholder="PIC Name" required/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6">
					<textarea class="form-control" name="data_document[process_notes]" placeholder="Notes" @if(isset($dataDoc['Training Completed']['process_name_by'])) disabled @endif>@if(isset($dataDoc['Training Completed']['process_notes'])) {{$dataDoc['Training Completed']['process_notes']}} disabled @endif</textarea>
				</div>
			</div>
			<div class="form-group">
