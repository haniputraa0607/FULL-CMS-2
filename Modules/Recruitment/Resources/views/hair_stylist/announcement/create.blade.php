...
<form role="form" action="{{ url('recruitment/hair-stylist/announcement/create') }}" method="POST" class="">
					...
					<div class="form-actions">
						...
						<div class="row">
							<div class="col-md-offset-2 col-md-10">
								<input type="hidden" name="id_hairstylist_announcement" value="{{ $ann['id_hairstylist_announcement'] ?? null }}">
