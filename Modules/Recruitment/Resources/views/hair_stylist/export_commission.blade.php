                    ...
                    $(".save").each(function() {
                        ...
                        $(this).click(function() {
                            swal({
                                ...
                                function(){
                                    window.location.href = "{{url('hair-stylist/commission/delete')}}/"+id;
                                });
                        })
                    })
                }
                ...
                @if(!empty($data))
                    @foreach($data as $val)
                        <tr style="text-align: center">
                            ...
                            @if($i==4)
                            <div style="display:none" id="myDIV{{ $val['id_export_commission_queue'] }}">
                            @endif
                            {{$va}}
                            @if($i<=4&&$i==$count)
                            </div>
                            ...
                            <td><button class="btn btn-sm btn-info" onclick="myFunction({{ $val['id_export_commission_queue'] }})">Show</div></button></td>
                            ...
                            <td>
                                @if($val['status_export'] == "Ready")
                                    ...
                                    <a class="btn red save" data-id="{{ $val['id_export_commission_queue'] }}" data-status="Rejected" data-form="approve"><i class="fa fa-trash-o"></i></a>
                                @else
                                    <a class="btn btn-sm btn-info"  href="{{url('hair-stylist/commission/filter')}}"><i class="fa fa-refresh"></i></a>
                                    <a class="btn red save" data-id="{{ $val['id_export_commission_queue'] }}" data-status="Rejected" data-form="approve"><i class="fa fa-trash-o"></i></a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
                @else
                    <tr><td colspan="6" style="text-align: center">Data Not Available</td></tr>
                @endif
                </tbody>
            </table>
        </div>
