                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  <option value="name_hs" @if ($con['subject'] == 'name_hs') selected @endif>Name Hair Stylist</option>
                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  ...
                                                  <option value="name_hs">Name Hair Stylist</option>
                          ...
                          <div class="mt-repeater-cell">
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-4">
                                      <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                          <option value="" selected disabled>Search Subject</option>
                                          <option value="name_has">Name Hair Stylist</option>
                                          <option value="outlet">Outlet</option>
