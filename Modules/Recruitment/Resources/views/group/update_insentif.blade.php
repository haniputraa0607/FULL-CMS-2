					...
					<div class="form-body">
						<input type="hidden" name="id_hairstylist_group_insentif" value="{{$result['id_hairstylist_group_insentif']}}">
                                                ...
                                                <label class="col-md-4 control-label">Name Insentif<span class="required" aria-required="true">*</span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" value="{{$result['name_insentif']??''}}" name="name_insentif" placeholder="Masukkan nama insentif" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="price_insentif" value="{{number_format($result['price_insentif']??0,0,',',',')}}" id='price_insentif' data-type="currency" placeholder="Masukkan nama insentif" class="form-control" required />
                                                    </div>
                                                </div>
