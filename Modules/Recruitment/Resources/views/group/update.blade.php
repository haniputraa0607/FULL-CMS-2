					...
					<div class="form-body">
						...
						<input type="hidden" name="id_product" value="{{$result['id_product']}}">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input class="form-control" disabled type="text" id="commission_percent" name="commission_percent" value="{{$result['hair_stylist_group_name']}}" placeholder="Enter Commission"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
