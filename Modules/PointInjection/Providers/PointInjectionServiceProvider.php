...
namespace Modules\PointInjection\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class PointInjectionServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'pointinjection');
    }
    ...
    {
        $langPath = resource_path('lang/modules/pointinjection');
