...
namespace Modules\PromoCampaign\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class PromoCampaignServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'promocampaign');
    }
    ...
    {
        $langPath = resource_path('lang/modules/promocampaign');
