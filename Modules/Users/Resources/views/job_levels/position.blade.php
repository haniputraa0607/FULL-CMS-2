    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function buildItem(item) {
                ...
                html += "<div class='dd-handle'>" + item.job_level_name + "</div>";
...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">Job Level Position</span>
            </div>
        </div>
        <div class="portlet-body form">
            <form action="{{url('job-level/position')}}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
