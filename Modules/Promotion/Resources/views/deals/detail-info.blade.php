        ...
        <div class="portlet profile-info portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <div class="row static-info">
                    ...
                    <div class="col-md-8 value">: 
                    	@php
                            foreach ($deals['deals_promotion_services'] as $key => $value) {
                                if ($key == 0) {
                                    $comma = '';
                                }else{
                                    $comma = ', ';
    ...
    <div class="col-md-7 profile-info">
    	@if (!empty($deals['is_offline']))
	    	<div class="profile-info portlet light bordered">
	            ...
	            <div class="row static-info">
	                <div class="col-md-11 value">
	                    <a class="btn blue" href="{{ url('/'.$rpage)}}/step2/{{$deals['id_deals_promotion_template']}}">Create Rule</a>
	                </div>
	            </div>
	            @endif
	        </div>
            ...
            @if ( 
                ...
                @if (isset($deals['deals_promotion_product_discount_rules']) && $deals['deals_promotion_product_discount_rules'] != null)
                    ...
                    <div class="mt-comments">
                        @if ($deals['deals_promotion_product_discount_rules'] != null)
                            @if(isset($deals['deals_promotion_product_discount_rules']['is_all_product']) && $deals['deals_promotion_product_discount_rules']['is_all_product'] == '0')
                ...
                @elseif (isset($deals['deals_promotion_tier_discount_rules']) && $deals['deals_promotion_tier_discount_rules'] != null)
                    ...
                    <div class="row static-info">
                        <div class="col-md-4 name">Product Requirement</div>
                        <div class="col-md-8 value">: 
                        	@if ( ($deals['deals_promotion_tier_discount_rules'][0]['is_all_product'] ?? false) == '1' )
                                All Product
                            @elseif ( ($deals['deals_promotion_tier_discount_rules'][0]['is_all_product'] ?? false) == '0' )
                                Selected Product
                            @endif
                    ...
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_6">
                        <thead>
                            <tr>
                                <th>Min Qty</th>
                                <th>Max Qty</th>
                                <th>{{ ($deals['deals_promotion_tier_discount_rules'][0]['discount_type']??'').' Discount' }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($deals['deals_promotion_tier_discount_rules'] as $res)
                                <tr>
                                    ...
                                    <td>{{ ($deals['deals_promotion_tier_discount_rules'][0]['discount_type'] == 'Percent') ? ( $res['discount_value'].' % (Max : IDR '.number_format($res['max_percent_discount']).')' ) : ('IDR '.number_format($res['discount_value'])) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                @elseif (isset($deals['deals_promotion_buyxgety_rules']) && $deals['deals_promotion_buyxgety_rules'] != null)
                    ...
                    <div class="row static-info">
                        <div class="col-md-4 name">Product Requirement</div>
                        <div class="col-md-8 value">: 
                        	@if ( ($deals['deals_promotion_buyxgety_rules'][0]['is_all_product'] ?? false) == '1' )
                                All Product
                            @elseif ( ($deals['deals_promotion_buyxgety_rules'][0]['is_all_product'] ?? false) == '0' )
                                Selected Product
                            @endif
