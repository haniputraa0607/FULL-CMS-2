...
namespace Modules\InboxGlobal\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class InboxGlobalServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'inboxglobal');
    }
    ...
    {
        $langPath = resource_path('lang/modules/inboxglobal');
