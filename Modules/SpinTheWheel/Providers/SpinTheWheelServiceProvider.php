...
namespace Modules\SpinTheWheel\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class SpinTheWheelServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'spinthewheel');
    }
    ...
    {
        $langPath = resource_path('lang/modules/spinthewheel');
