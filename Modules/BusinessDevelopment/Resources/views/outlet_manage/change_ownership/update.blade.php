...
<script>
            ...
            return {
                init: function() {
                    $(".sweetalert-reject").each(function() {
                        ...
                        var data = {
                                    '_token' : '{{csrf_token()}}',
                                    'id_outlet_change_ownership':{{$result['id_outlet_change_ownership']}}
                                        };
                        $(this).click(function() {
                            swal({
                                ...
                                function(){
                                    $.ajax({
                                        type : "POST",
                                        url : "{{url('businessdev/partners/outlet/change/reject')}}",
                                        data : data,
                        ...
                        $(this).click(function() {
                            swal({
                                ...
                                function(){
                                    $.ajax({
                                        type : "POST",
                                        url : "{{url('businessdev/partners/outlet/change/success')}}",
                                        data : data,
                                        success : function(response) {
                                            if (response.status == 'success') {
    ...
    <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="{{url('businessdev/partners/outlet/change/update')}}" method="post" enctype="multipart/form-data">
               
                        <div class="form-body">
                            <input class="form-control" type="hidden" id="id_outlet_change_ownership" name="id_outlet_change_ownership" value="{{$result['id_outlet_change_ownership']}}"/>
