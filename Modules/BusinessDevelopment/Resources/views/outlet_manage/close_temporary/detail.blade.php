    ...
    <div class="portlet light bordered">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="overview">
               @include('businessdevelopment::outlet_manage.close_temporary.update')
            </div>
            <div class="tab-pane" id="document">
                 @include('businessdevelopment::outlet_manage.close_temporary.document')
            </div>
            @if($result['status']=="Process")
            <div class="tab-pane" id="create">
                @include('businessdevelopment::outlet_manage.close_temporary.create_lampiran')
            </div>
            @endif
        </div>
    </div>
