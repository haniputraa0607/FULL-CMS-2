        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <div class="tab-content">
                    ...
                    <div class="tab-pane @if($result['status']=='Process' || $confir == true) active @endif" id="form_confir">
                        <form class="form-horizontal" role="form" action="{{url('businessdev/partners/outlet/close/create-follow-up')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" type="text" id="no_letter" name="no_letter" placeholder="Enter reference number here" required @if ($confir==true) readonly value="{{$result['letter']['no_letter']}}" @endif/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" type="text" id="location_letter" name="location_letter" placeholder="Enter location letter here" required @if ($confir==true) readonly value="{{$result['letter']['location']}}" @endif/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <textarea style="height: 200px" name="payment_note" id="payment_note" class="form-control" placeholder="Final Payment akan diangsur ..." @if ($confir==true) readonly @endif>{{ $result['lokasi']['notes'] }}</textarea>
                                    </div>
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <label for="example-search-input" class="control-label col-md-4">
                                            <a href="{{ env('STORAGE_URL_API').$result['letter']['attachment'] }}">Download Confirmation Letter</a>
                                        <label>
                                    </div>
                                </div>    
                                @endif
