        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <div class="tab-content">
                    ...
                    <div class="tab-pane @if($result['status']=='Process' || $surv == true) active @endif" id="form_survey">
                        <form class="form-horizontal" role="form" action="{{url('businessdev/partners/outlet/close/create-follow-up')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-icon right">
                                            @if ($surv==true)
                                            <input class="form-control" type="text" id="follow_up" name="survey_potential" @if ($surv==true) readonly value="{{$result['form'][0]['potential']}}" @endif required/>
                                            @else    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <textarea style="height: 80px" name="surye_note" id="surye_note" class="form-control" placeholder="Enter survey note here" @if ($surv==true) readonly @endif>@if ($surv==true) {{$result['form'][0]['note']}} @endif</textarea>
                                    </div>
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <label for="example-search-input" class="control-label col-md-4">
                                            <a href="{{  env('STORAGE_URL_API').$result['form'][0]['attachment'] }}">Download Form Survey</a>
                                        <label>
                                    </div>
                                </div>    
                                @endif
