...
<script>
                        ...
                        $(this).click(function() {
                            swal({
                                ...
                                function(){
                                    $.ajax({
                                        type : "POST",
                                        url : "{{url('businessdev/partners/outlet/close/success')}}",
                                        data : data,
                                        success : function(response) {
                                            if (response.status == 'success') {
     ...
     <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="{{url('businessdev/partners/outlet/close/update')}}" method="post" enctype="multipart/form-data">
