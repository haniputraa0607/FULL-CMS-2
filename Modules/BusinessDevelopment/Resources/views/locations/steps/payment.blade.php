                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control numberonly" type="text" id="rental_price" name="rental_price" placeholder="Enter rental price here" value="{{ old('rental_price') ? old('rental_price') :$result['rental_price']}}" required {{$pay ? 'disabled' : ''}}/>
                                        </div>
                                    </div>
                                </div>    
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input class="form-control numberonly" type="text" id="service_charge" name="service_charge" placeholder="Enter service charge here" value="{{ old('service_charge') ? old('service_charge') :$result['service_charge']}}" required {{$pay ? 'disabled' : ''}}/>
                                        </div>
                                    </div>
                                </div>    
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input class="form-control numberonly" type="text" id="promotion_levy" name="promotion_levy" placeholder="Enter promotion levy here"  value="{{ old('promotion_levy') ? old('promotion_levy') :$result['promotion_levy']}}" required {{$pay ? 'disabled' : ''}}/>
                                        </div>
                                    </div>
                                </div>    
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="example-search-input" class="control-label col-md-4">End Date
                                        <i class="fa fa-question-circle tooltips" data-original-title="Tanggal berakhir menjadi partner atau tanggal kerja sama selesai, bisa dikosongkan dan diisi saat proses approve partner" data-container="body"></i></label>
                                    <div class="col-md-5">
                                        <div class="input-group">
