                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  <option value="name" @if ($con['subject'] == 'name') selected @endif>Name Location</option>
                                                  <option value="name_partner" @if ($con['subject'] == 'name_partner') selected @endif>Name Partner</option>
                                                  <option value="address" @if ($con['subject'] == 'address') selected @endif>Address</option>
                                              </select>
                                          </div>
                                          <div class="col-md-4">
                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  ...
                                                  <option value="name">Name Location</option>
                                                  <option value="name_partner">Name Partner</option>
