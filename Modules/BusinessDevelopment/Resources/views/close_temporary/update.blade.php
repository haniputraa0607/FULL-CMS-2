...
<script>
                        ...
                        $(this).click(function() {
                            swal({
                                ...
                                function(){
                                    $.ajax({
                                        type : "POST",
                                        url : "{{url('businessdev/partners/close-temporary/success')}}",
                                        data : data,
                                        success : function(response) {
                                            if (response.status == 'success') {
    ...
    <div class="portlet-body form">
                @if(!empty($result['close_date']))
                    <form class="form-horizontal" role="form" action="{{url('businessdev/partners/close-temporary/update')}}" method="post" enctype="multipart/form-data">
                @else
                    <form class="form-horizontal" role="form" action="{{url('businessdev/partners/close-temporary/updateActive')}}" method="post" enctype="multipart/form-data">
                @endif
                        <div class="form-body">
                            <input class="form-control" type="hidden" id="id_partners_close_temporary" name="id_partners_close_temporary" value="{{$result['id_partners_close_temporary']}}"/>
