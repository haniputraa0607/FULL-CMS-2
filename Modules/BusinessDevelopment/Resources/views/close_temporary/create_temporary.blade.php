...
<div class="portlet-body form">
    <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject sbold uppercase font-blue">{{$title_temporary}}</span>
            </div>
        </div>
     @if($url == false)
                    <form class="form-horizontal" role="form" action="{{url('businessdev/partners/close-temporary/create')}}" method="post" enctype="multipart/form-data">
                @else
                    <form class="form-horizontal" role="form" action="{{url('businessdev/partners/close-temporary/createActive')}}" method="post" enctype="multipart/form-data">
                @endif
