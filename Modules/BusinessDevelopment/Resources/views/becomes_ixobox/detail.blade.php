    ...
    <div class="portlet light bordered">
        ...
        <div class="tabbable-line tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#overview" data-toggle="tab"> Partner Becomes Ixobox</a>
                </li>
                <li>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="overview">
               @include('businessdevelopment::becomes_ixobox.update')
            </div>
            <div class="tab-pane" id="document">
                @include('businessdevelopment::becomes_ixobox.document')
            </div>
            @if($result['status']=="Process")
            <div class="tab-pane" id="create">
                @include('businessdevelopment::becomes_ixobox.create')
            </div>
            @endif
            @if($result['outlet']!=false)
            <div class="tab-pane" id="outlet">
                @include('businessdevelopment::becomes_ixobox.outlet')    
            </div>
            @endif
        </div>
    </div>
