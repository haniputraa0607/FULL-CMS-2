    ...
    <div class="portlet light bordered">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="overview">
               @include('businessdevelopment::close_permanent.update')
            </div>
            <div class="tab-pane" id="document">
                @include('businessdevelopment::close_permanent.document')
            </div>
            @if($result['status']=="Process")
            <div class="tab-pane" id="create">
                @include('businessdevelopment::close_permanent.create')
            </div>
            @endif
            @if($result['outlet']!=false)
            <div class="tab-pane" id="outlet">
                @include('businessdevelopment::close_permanent.outlet')
            </div>
            @endif
        </div>
    </div>
