    ...
    <div class="portlet light bordered">
        ...
        <div class="tabbable-line tabbable-full-width">
            <ul class="nav nav-tabs">
                ...
                @if($status == true)
                <li>
                    <a href="#create_permanent" data-toggle="tab"> Create Closure Permanent</a>
                </li>
                @endif
            </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="overview">
                @include('businessdevelopment::close_permanent.overview')
            </div>
            <div class="tab-pane" id="create_permanent">
                @include('businessdevelopment::close_permanent.create_permanent')
            </div>
