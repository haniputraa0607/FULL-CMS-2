                        ...
                        <form class="form-horizontal" role="form" action="{{url('businessdev/partners/create-follow-up')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <textarea style="height: 80px" class="form-control" placeholder="- " readonly >{{ $confirmation['location'][0]['address'] ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="example-search-input" class="control-label col-md-4">Total Payment <span class="required" aria-required="true">*</span>
                                        <i class="fa fa-question-circle tooltips" data-original-title="Biaya kerja sama yang akan dibayarkan partner ke IXOBOX @if(isset($result['partner_locations'][0]['value_detail_decode']['Inisiasi Partner']['netto'])) sudah  @else belum @endif termasuk PPN 10%" data-container="body"></i></label>
                                    <div class="col-md-5">
