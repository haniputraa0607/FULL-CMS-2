                    ...
                    <div class="tab-pane @if($result['status']=='Candidate' || $select == true) active @endif" id="form_calcu">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select name="cooperation_scheme" id="cooperation_scheme" onchange="cooperation()" class="form-control input-sm select2" placeholder="Cooperation Scheme" required {{ $select ? 'disabled' : ''}}>
