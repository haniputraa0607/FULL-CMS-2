...
@section('page-script')
    ...
    <script type="text/javascript">
        $('.switch').on('click', function(e){
            ...
            $.ajax({
                type : "POST",
                url : "{{ url('welcome-voucher/update/status') }}",
        ...
        function deleteDeals(id_deals){
            if(confirm('Are you sure you want to delete this deals from list?')) {
                $('#div_'+id_deals).remove()
            }
...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase ">Welcome Voucher Setting</span>
            </div>
        </div>
