...
@section('page-script')
    <script type="text/javascript">
        ...
        $('.switch-change').on('switchChange.bootstrapSwitch', function (event, state) {
            ...
            html += '<form action="{{url('fraud-detection/update/suspend')}}/transaction-week/'+phone+'" role="form" method="POST" id="formSuspend">';
...
@section('content')
    ...
    <h1 class="page-title">
        <div class="row">
            <div class="col-md-6">
                Detail Report Fraud Transaction Week
            </div>
            <div class="col-md-6" style="text-align: right">
                <a href="{{url('fraud-detection/report/transaction-week')}}" class="btn green" style="margin-bottom: 2%;"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
        </div>
    </h1>
