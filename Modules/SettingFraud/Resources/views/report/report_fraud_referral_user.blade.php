...
@section('content')
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="tools">
                <a href="javascript:;" class="@if(Session::has('filter-fraud-referral-user'))  expand @else collapse @endif"> </a>
            </div>
        </div>
        <div class="portlet-body" @if(Session::has('filter-fraud-referral-user')) style="display: none;" @endif>
    ...
    @if(Session::has('filter-fraud-referral-user'))
        <?php
        $search_param = Session::get('filter-fraud-referral-user');
