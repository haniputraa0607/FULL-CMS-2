...
namespace Modules\SettingFraud\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class SettingFraudServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'settingfraud');
    }
    ...
    {
        $langPath = resource_path('lang/modules/settingfraud');
