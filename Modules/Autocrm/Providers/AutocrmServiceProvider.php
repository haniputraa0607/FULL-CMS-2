...
namespace Modules\Autocrm\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class AutocrmServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'autocrm');
    }
    ...
    {
        $langPath = resource_path('lang/modules/autocrm');
