<script>
    ...
    function changeSubject(val){
        ...
        if (subject_value == 'status') {
            ...
            operator_value.options[operator_value.options.length] = new Option('-', 'No Status');
        ...
        } else if(subject_value == 'role_name') {
			...
			operator_value.options[operator_value.options.length] = new Option("{{ $year }}", "{{ $year }}");
			@endforeach
                                                ...
                                                <select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
                                                    @if($con['subject'] == 'status')
		                                           	...
		                                           	@elseif ($con['subject'] == 'id_outlet')
														...
														@endforeach
                                                    @elseif ($con['subject'] == 'role_name')
														@foreach($roles ?? [] as $role)
															<option value="{{$role['id_role']}}" @if ($con['operator'] == $role['id_role']) selected @endif>{{$role['role_name']}}</option>
														@endforeach
													...
													@elseif ($con['subject'] == 'year')
														@foreach($years ?? [] as $year)
															<option value="{{ $year }}" @if ($con['operator'] == $year) selected @endif>{{ $year }}</option>
														@endforeach
                                                    @else
