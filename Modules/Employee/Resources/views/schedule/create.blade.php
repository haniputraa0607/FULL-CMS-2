...
@section('page-script')
    ...
    <script>
        ...
        function cekSchedule(){
            ...
            var id_employee = $('select[name=id_employee] option').filter(':selected').val()
            ...
            function(){
                $.ajax({
                    type : "POST",
                    url : "{{url('employee/schedule/check')}}",
                    data : data,
                ...
                <div class="form-body">
                    <div class="form-group">
                        <label for="example-search-input" class="control-label col-md-4">Select Employee <span class="required" aria-required="true">*</span>
                            <i class="fa fa-question-circle tooltips" data-original-title="Pilih nama karyawan yang akan dibuat jadwalnya" data-container="body"></i></label>
                        <div class="col-md-5">
                            <select class="form-control select2" name="id_employee" required>
