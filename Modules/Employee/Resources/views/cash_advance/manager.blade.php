    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            <table class="table table-striped table-bordered table-hover" id="kt_datatable">
                        ...
                        @if(!empty($data))
                            @foreach($data as $dt)
                                <tr data-id="{{ $dt['id_employee_reimbursement'] }}">
                                    <td>{{$dt['user_name']}}</td>
                                    <td>{{$dt['email']}}</td>
                                    ...
                                    <td align="center"> 
                                        <a href="{{ url('/employee/reimbursement/manager/detail/'.$dt['id_employee_reimbursement']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-pencil"></i> Proses</a>
