...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject sbold uppercase font-blue">List Loan</span>
            </div>
        </div>
                                        ...
                                        @foreach($list as $dt)
                                            <tr data-id="{{ $dt['id_asset_inventory'] }}">
                                                ...
                                                <td style="text-align: center;">
                                                   <a href="{{ url('employee/asset-inventory/loan/detail/'.$dt['id_enkripsi']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-search"></i> Detail</a>
