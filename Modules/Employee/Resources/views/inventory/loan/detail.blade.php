...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{url('employee/asset-inventory/loan/approve')}}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label for="example-search-input" class="control-label col-md-4">Date Approve
                    ...
                    <div class="form-group">
                        <label for="example-search-input" class="control-label col-md-4">Notes 
                            <i class="fa fa-question-circle tooltips" data-original-title="Status pengajuan asset & inventory" data-container="body"></i></label>
                        <div class="col-md-5">
                            <textarea s class="form-control" name="notes" placeholder="Notes" >{{$result['notes']??''}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
