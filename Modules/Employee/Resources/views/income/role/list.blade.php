    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            <table class="table table-striped table-bordered table-hover" id="kt_datatable">
                        ...
                        @if(!empty($data))
                            @foreach($data as $dt)
                                <tr data-id="{{ $dt['id_role'] }}">
                                    <td>{{$dt['role_name']}}</td>
                                    <td style="text-align: center;"><a href="{{ url('employee/income/role/detail/'.$dt['id_enkripsi']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-search"></i> Detail</a></td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
