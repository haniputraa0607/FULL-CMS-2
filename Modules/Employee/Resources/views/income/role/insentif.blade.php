                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="table_insentif">
                        <div class="table-responsive">
                          <form role="form" action="{{url('employee/income/role/incentive/create')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        @foreach($insentif as $key => $dt)
                                            <tr style="text-align: center" >
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <input type="hidden" name="id_employee_role_default_incentive[]" value="{{$dt['id_employee_role_default_incentive']}}"/>
