    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            <table class="table table-striped table-bordered table-hover" id="kt_datatable">
                        ...
                        @if(!empty($data))
                            @foreach($data as $dt)
                                <tr data-id="{{ $dt['id_employee_income'] }}">
                                    <td>{{$dt['name']}}</td>
                                    <td>{{$dt['phone']}}</td>
                                    <td>{{$dt['email']}}</td>
                                    ...
                                    <td>{{$dt['status']}}</td>
                                    <td> 
                                        <a href="{{ url('employee/income/payslip/detail/'.$dt['id_enkripsi']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-search"></i> Detail</a>
