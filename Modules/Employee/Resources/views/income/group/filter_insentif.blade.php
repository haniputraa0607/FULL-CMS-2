...
@endsection
@section('filter_insentif')
<form action="{{url('recruitment/hair-stylist/group/commission/filter_insentif')}}" method="post">
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption font-blue ">
				<i class="icon-settings font-blue "></i>
				<span class="caption-subject bold uppercase">Filter Insentif</span>
			</div>
		</div>
                                                                ...
                                                                <div class="form-group">
                                                                        <div >
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    ...
                                                                                    <input type="hidden" placeholder="Keyword" class="form-control" name="subject" value="name_potongan"  required/>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <select name="operator" class="form-control input-sm " placeholder="Search Rule" required>
                                                                                                <option @if(isset($filter_insentif['operator'])) @if($filter_insentif['operator'] == '=') selected @endif @endif value="=" >=</option>
                                                                                                <option @if(isset($filter_insentif['operator'])) @if($filter_insentif['operator'] == 'like') selected @endif @endif value="like" >Like</option>
                                                                                        </select>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <input type="text" placeholder="Keyword" class="form-control" name="value" value="{{$filter_insentif['value']??''}}"  required/>
                                                                                </div>
                                                                                    <div class="col-md-3">
                                                                                        {{ csrf_field() }}
