    ...
    <div class="portlet light bordered">
        ...
        <div class="tabbable-line tabbable-full-width">
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="kt_datatable">
                                    ...
                                    @if(!empty($data))
                                        @foreach($data as $dt)
                                            <tr data-id="{{ $dt['id_employee_role_default_fixed_incentive'] }}">
            ...
            <div class="tab-pane" id="create">
                <form class="form-horizontal" role="form" action="{{url('employee/income/default/fixed-incentive/create')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
