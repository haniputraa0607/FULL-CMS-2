    ...
    <div class="portlet light bordered">
        ...
        <div class="tabbable-line tabbable-full-width">
            ...
            <div class="tab-pane active" id="update">
				...
				<form role="form" class="form-horizontal" action="{{url('employee/income/default/fixed-incentive/update')}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="form-body">
						<input type="hidden" name="id_employee_role_default_fixed_incentive" value="{{$result['id_employee_role_default_fixed_incentive']}}">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="kt_datatable">
                                    ...
                                    @if(!empty($detail))
                                        @foreach($detail as $dts)
                                            <tr data-id="{{ $dts['id_employee_role_default_fixed_incentive_detail'] }}">
                                                ...
                                                <td style="text-align: center;">
                                                   ...
                                                   <a class="btn btn-sm red btn-primary" href="{{url('employee/income/default/fixed-incentive/detail/delete/'.$dts['id_employee_role_default_fixed_incentive_detail'])}}"><i class="fa fa-trash-o"></i> Delete</a>
                                                   @endif
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="tab-pane" id="create">
                <div class="portlet-body form">
                <form class="form-horizontal" role="form" action="{{url('employee/income/default/fixed-incentive/type2')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                <input type="hidden" name="id_employee_role_default_fixed_incentive" value="{{$result['id_employee_role_default_fixed_incentive']}}">
                                <div class="form-group">
            ...
            <div class="tab-pane" id="create_detail">
                <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="{{url('employee/income/default/fixed-incentive/type1')}}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_employee_role_default_fixed_incentive" value="{{$result['id_employee_role_default_fixed_incentive']}}">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-4 control-label">Value<span class="required" aria-required="true">*</span>
