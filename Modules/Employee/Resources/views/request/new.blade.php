...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-dark sbold uppercase font-blue">New Request Employee</span>
            </div>
        </div>
            ...
            <form class="form-horizontal" role="form" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select class="form-control select2" name="id_outlet" required>
                                <option value="" selected disabled>Select Outlet</option>
                                @foreach($office as $o => $ol)
                    ...
                    <div class="form-group">
                        <label for="example-search-input" class="control-label col-md-4">Notes 
                            <i class="fa fa-question-circle tooltips" data-original-title="Catatan dari office manager" data-container="body"></i></label>
                        <div class="col-md-5">
                            <textarea name="notes_om" id="input-note" class="form-control" placeholder="Enter note here" required></textarea>
                        </div>
                    </div>
                </div>
