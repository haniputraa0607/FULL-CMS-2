...
@section('page-script')
    ...
    <script type="text/javascript">
                ...
                success: function(result){
                    if(result['status']=='success'){    
                        ...
                        $.each(new_result, function(i, index) {
                            list += '<option value="'+index.date+'" data-id="'+index.id_employee_schedule_date+'" data-timestart="'+index.time_start+'" data-timeend="'+index.time_end+'">'+index.date_format+'</option>';
                        });
        ...
        $('#list_date').on("change",function(){
            ...
            var type = $('input[type=hidden][name=id_employee_schedule_date]').val(id);
        });
        ...
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action="{{ url('employee/timeoff/create') }}" method="post" enctype="multipart/form-data" id="create-time-off">
                <div class="form-body">
                    ...
                    <input type="hidden" name="id_employee_schedule_date" value="">
                </div>
