                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  <option value="name_employee" @if ($con['subject'] == 'name_employee') selected @endif>Name Employee</option>
                                                  <option value="outlet" @if ($con['subject'] == 'outlet') selected @endif>Office</option>
                                                  <option value="request" @if ($con['subject'] == 'request') selected @endif>Request By</option>
                                              </select>
                                          </div>
                                          <div class="col-md-4">
                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  ...
                                                  <option value="name_employee">Name Employee</option>
                                                  <option value="outlet">Office</option>
                                                  <option value="request">Request By</option>
                                              </select>
                                          </div>
                                          <div class="col-md-4">
                                              <select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">
                          ...
                          <div class="mt-repeater-cell">
                              <div class="col-md-12">
                                  ...
                                  <div class="col-md-4">
                                      <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                          <option value="" selected disabled>Search Subject</option>
                                          <option value="name_has">Name Employee</option>
                                          <option value="outlet">Office</option>
