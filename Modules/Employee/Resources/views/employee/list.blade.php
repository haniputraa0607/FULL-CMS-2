                            ...
                            @foreach($data as $dt)
                                <tr data-id="{{ $dt['id_employee'] }}">
                                    ...
                                    <td> 
                                        ...
                                        <a href="{{ url('employee/recruitment/candidate/detail/'.$dt['id_employee']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-pencil"></i> Edit</a>
                                        ...
                                        @else
                                        <a href="{{ url('employee/recruitment/candidate/detail/'.$dt['id_employee']) }}" class="btn btn-sm blue text-nowrap"><i class="fa fa-search"></i> Detail</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
