			...
			<div class="form-group">
				...
				<div class="col-md-6">
					@if(isset($dataDoc['HRGA']['attachment']))
						...
						@else
							<a style="margin-top: 2%" class="btn blue btn-xs" href="{{url('recruitment/hair-stylist/detail/download-file', $dataDoc['HRGA']['id_employee_document'])}}"><i class="fa fa-download"></i></a>
						@endif
					@else
