					...
					<div class="portlet-body">
						<form role="form" class="form-horizontal" action="{{url()->current()}}" method="POST">
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="number" class="form-control" min="1" name="employee_clock_in_tolerance" value="{{$result['employee_clock_in_tolerance']??null}}">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										<input type="number" class="form-control" min="1" name="employee_clock_out_tolerance" value="{{$result['employee_clock_out_tolerance']??null}}">
										<span class="input-group-addon">minutes</span>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-4">
									<div class="input-group">
										...
										<input type="number" class="form-control" min="1" name="employee_attendance_max_radius" value="{{$result['employee_attendance_max_radius']??null}}">
