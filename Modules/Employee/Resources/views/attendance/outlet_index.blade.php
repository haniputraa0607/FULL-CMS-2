        ...
        columns: [
            ...
            {data: 'total_attendance'},
            {
                ...
                render: (data, type, full) => {
                    return `
                        <a href="${'{{url('employee/attendance-outlet/detail/::id::')}}'.replace('::id::', data)}" class="btn btn-primary btn-sm">Detail</a>
                    `;
                }
            },
        ]
...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject sbold uppercase font-blue">List Employee Outlet Attendance</span>
            </div>
        </div>
