                ...
                <div class="portlet-body form">
                    <form class="form-horizontal" role="form" action="{{url('employee/reimbursement/create')}}" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Name Validator</label>
                                    <div class="col-md-6 input-group">
                                        <input type="text" class="form-control" name="validator_reimbursement" id="validator_reimbursement " placeholder="Masukkan notes" value="{{$data['validator_reimbursement']??''}}" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Name Validator<span class="required" aria-required="true">*</span>
                                        <i class="fa fa-question-circle tooltips" data-original-title="Menambahkan nama pimpinan yang memproses pengajuan reimbursement" data-container="body"></i>
                                    </label>
                                    <div class="col-md-6 input-group">
                                        <input type="text" class="form-control" name="validator_reimbursement" id="validator_reimbursement " placeholder="Masukkan notes" required/>
                                    </div>
                                </div>
                                <div class="form-group">
