	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				<form role="form" class="form-horizontal" action="{{url('setting/mitra-apps/splash-screen')}}" method="POST" enctype="multipart/form-data">
					<div class="form-body">
						<div class="form-group col-md-12">
							...
							<div class="col-md-4">
								<input type="number" class="form-control" name="default_splash_screen_mitra_apps_duration" value="{{$result_splash_screen['default_splash_screen_mitra_apps_duration']??''}}" min="1">
							</div>
						</div>
						<div class="form-group col-md-12">
							...
							<div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
								<div class="fileinput-new thumbnail">
									@if(isset($result_splash_screen['default_splash_screen_mitra_apps']))
										<img src="{{$result_splash_screen['default_splash_screen_mitra_apps']}}?" alt="">
									@else
								...
								<div>
									...
									<input type="file" class="file file-splash" id="field_splash" accept="image/*" name="default_splash_screen_mitra_apps">
									</span>
