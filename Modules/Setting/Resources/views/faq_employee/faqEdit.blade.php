...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form class="form-horizontal form-bordered" action="{{ url('setting/employee/faq/update', $faq['id_employee_faq']) }}" method="post">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="answer" class="form-control">{{ $faq['faq_answer']??'' }}</textarea>
                        </div>
                    </div>
                </div>
