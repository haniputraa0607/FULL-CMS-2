				...
				<form action="{{ url('setting/featured_deal/reorder') }}" method="POST">
					<div class="clearfix" id="sortable2">
						@foreach ($featured_deals as $key => $featured_deal)
						 <div class="portlet portlet-sortable light bordered col-md-3" style="height: 300px !important">
							 <div class="portlet-title">
								<div class="row">
									<div class="col-md-2">
								...
								<div class="portlet-body">
										...
										<center><img src="{{ $featured_deal['deals']['url_deals_image'] }}" alt="FeaturedDeal Image" width="150" height="100"></center>
								</div>
