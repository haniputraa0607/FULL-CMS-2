...
namespace Modules\UserFeedback\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class UserFeedbackServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'userfeedback');
    }
    ...
    {
        $langPath = resource_path('lang/modules/userfeedback');
