...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">Office Branch List</span>
            </div>
        </div>
                                ...
                                @if(MyHelper::hasAccess([25,27,28], $grantedFeature))
                                    <td style="width: 90px;">
                                        ...
                                        @if(MyHelper::hasAccess([25,27], $grantedFeature))
                                            <a href="{{ url('office-branch/detail') }}/{{ $value['outlet_code'] }}" class="btn btn-sm blue"><i class="fa fa-search"></i></a>
                                        @endif
                                    </td>
                                @endif
                            </tr>
