            ...
            $.ajax({
                ...
                success : function(result) {
                    if (result == "success") {
                        ...
                        toastr.info("Office holiday has been deleted.");
                    }
                    else {
...
@section('content')
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">New Office Holiday</span>
            </div>
        </div>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <div class="input-icon right">
                            ...
                            Office
                            <span class="required" aria-required="true"> * </span>
                            <i class="fa fa-question-circle tooltips" data-original-title="Pilih Office yang akan diberlakukan hari libur tersebut" data-container="body"></i>
                            </label>
                        </div>
                        <div class="col-md-9">
                            <div>
                                <div class="md-checkbox">
                                    ...
                                    <label for="select_all">
                                        <span></span>
                                        <span class="check"></span>
                                        <span class="box"></span>  Select All Office </label>
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-blue sbold uppercase">List Office Holiday</span>
            </div>
        </div>
        <div class="portlet-body form">
