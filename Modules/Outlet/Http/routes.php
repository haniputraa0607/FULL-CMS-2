...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'office-branch', 'namespace' => 'Modules\Outlet\Http\Controllers'], function()
{
    ...
    Route::any('detail/{id}', ['middleware' => 'feature_control:448', 'uses' => 'OfficeBranchController@detail']);
...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'outlet', 'namespace' => 'Modules\Outlet\Http\Controllers'], function()
{
    ...
    Route::get('detail/{id}/refresh-product', ['middleware' => 'feature_control:25', 'uses' => 'OutletController@refreshProduct']);
    ...
    Route::any('detail/{outlet_code}/refresh-report-stock', ['middleware' => 'feature_control:447', 'uses' => 'OutletController@refreshReportStock']);
    ...
    Route::any('detail/{outlet_code}/report-product-log', ['middleware' => 'feature_control:447', 'uses' => 'OutletController@exportProductLog']);
    ...
    Route::post('schedule/save', ['middleware' => [], 'uses' => 'OutletController@scheduleSave']);
    //different price
