  ...
  function changeSelect(){
    ...
    function changeSubject(val){
        ...
        if(subject_value == 'status'){
            ...
            operator_value.options[operator_value.options.length] = new Option('Unactive', '0');
                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <div class="col-md-4">
                                              <select name="subject" class="form-control input-sm select2" placeholder="Search Subject" onChange="changeSubject(this.name)" style="width:100%">
                                                  <option value="name" @if ($con['subject'] == 'name') selected @endif>Catalog Name</option>
                                                  <option value="company_type" @if ($con['subject'] == 'company_type') selected @endif>Company Type</option>
                                          ...
                                          <div class="col-md-4">
                                              <select name="operator" class="form-control input-sm select2" placeholder="Search Operator" id="test" style="width:100%">                
                                                  @if($con['subject'] == 'status')
                                                    <option value="1" @if ($con['operator'] == '1') selected @endif>Active</option>
                                                    <option value="0" @if ($con['operator'] == '0') selected @endif>Unactive</option>
                                                  @else
