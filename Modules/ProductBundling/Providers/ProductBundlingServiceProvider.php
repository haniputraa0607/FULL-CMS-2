...
namespace Modules\ProductBundling\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;

class ProductBundlingServiceProvider extends ServiceProvider
{
    /**
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'productbundling');
    }
    ...
    {
        $langPath = resource_path('lang/modules/productbundling');
