...
Route::group(['middleware' => ['web', 'validate_session'], 'prefix' => 'transaction', 'namespace' => 'Modules\Transaction\Http\Controllers'], function()
{
    ...
    Route::group(['prefix' => 'outlet-service'], function(){
    	...
    	Route::get('manage', ['middleware' => 'feature_control:392', 'uses' => 'TransactionOutletServiceController@manageList']);
    	Route::post('manage', ['middleware' => 'feature_control:392', 'uses' => 'TransactionOutletServiceController@manageFilter']);
    	Route::get('manage/detail/{id_transaction}', ['middleware' => 'feature_control:393', 'uses' => 'TransactionOutletServiceController@manageDetail']);
    	Route::post('manage/detail/{id_transaction}', ['middleware' => 'feature_control:394', 'uses' => 'TransactionOutletServiceController@manageDetailUpdate']);
    });
    ...
    Route::group(['prefix' => 'academy'], function(){
        ...
        Route::get('detail/{id_transaction}', [ 'uses' => 'TransactionAcademyController@detailAcademy']);
    });
