...
@section('content')
	...
	<div style="max-width: 480px; margin: auto">
        ...
        <?php
        $color = [
            'Wating Complete Payment' => '#939899',
            'Completed' => '#26C281',
            'Cancelled' => '#F3565D'
        ];

        if($data['hair_stylist_status'] == null){
            $data['hair_stylist_status'] = 'Wating Complete Payment';
        }
        ?>
            ...
            <div class="container" style="padding: 10px;margin-top: 10px;">
                <div class="text-center">
                    ...
                    <div class="col-12 text-13-3px" style="padding-bottom: 25px;color: #000000;font-size: 15px">
                        ...
                        Book time : {{date('d M Y H:i', strtotime($data['booking_date'].' '.$data['booking_time']))}}<br>
	                ...
	                @if(!empty($data['product_service']))
		                @foreach ($data['product_service'] as $trx)
                            ...
                            @if($trx['transaction_product_discount'])
                                ...
                                <div class="col-3 text-13-3px text-right WorkSans-Medium space-text" style="color:#a6ba35;">- {{number_format($trx['transaction_product_discount'], 0, ',', '.')}}</div>
                            @endif
		                @endforeach
	                @endif
	            </div>
