            ...
            columns: [
                {
                    ...
                    render: function(value, type, row) {
                        ...
                        const buttons = [
                            `<a class="btn blue btn-sm btn-outline" href="{{url('transaction/outlet-service/manage/detail')}}/${row.id_transaction}">Detail Transaction ${tooltipDetailTransaction}</a>`
                        ];
